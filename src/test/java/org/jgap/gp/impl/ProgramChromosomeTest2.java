 ...
 * 
 * 
 * @Julien : Completely underterministic. Removed from test by simple removal
 */
public class ProgramChromosomeTest2 extends GPTestCase {
	/** String containing the CVS revision. Read out via reflection! */
	private final static String CVS_REVISION = "$Revision: 1.14 $";

	public static Test suite() {
		TestSuite suite = new TestSuite(ProgramChromosomeTest2.class);
		return suite;
	}
	...
	public void testGrowNode_0() throws Exception {
		...
		pc.growOrFullNode(0, 3, CommandGene.IntegerClass, 0, funcSet, null, 0,
				true, -1, false);
		pc.redepth();
	 ...
	 * @since 3.0
	 */
	public void testGrowNode_1() throws Exception {
		IGPProgram ind = new GPProgram(m_gpconf, 5);
		ProgramChromosome pc = new ProgramChromosome(m_gpconf, 50, ind);
		CommandGene[] funcSet = new CommandGene[] { CMD_SUB_V_I, // 0
				CMD_FOR, // 1
		...
		pc.growOrFullNode(0, 5, CommandGene.IntegerClass, 0, funcSet,
				CMD_SUB_V_I, 0, true, -1, false);
		pc.redepth();
		assertEquals(CMD_SUB_V_I.toString(), pc.getNode(0).toString());
		assertEquals(CMD_FOR.toString(), pc.getNode(1).toString());
	 ...
	 * @since 3.0
	 */
	public void testGrowNode_2() throws Exception {
		IGPProgram ind = new GPProgram(m_gpconf, 5);
		ProgramChromosome pc = new ProgramChromosome(m_gpconf, 50, ind);
		CommandGene[] funcSet = new CommandGene[] { CMD_SUB_V_V_V, // 0
				CMD_FORX, // 1
				CMD_NOP, // 2
		...
		pc.growOrFullNode(0, 5, CommandGene.IntegerClass, 0, funcSet, CMD_FORX,
				0, true, -1, false);
		pc.redepth();
	 ...
	 * @since 3.0
	 */
	public void testGrowNode_3() throws Exception {
		IGPProgram ind = new GPProgram(m_gpconf, 5);
		ProgramChromosome pc = new ProgramChromosome(m_gpconf, 50, ind);
		CommandGene[] funcSet = new CommandGene[] { CMD_SUB_V_V_V, // 0
				CMD_FOR, // 1
		...
		pc.growOrFullNode(0, 5, CommandGene.IntegerClass, 0, funcSet, CMD_FOR,
				0, true, -1, false);
		pc.redepth();
	 ...
	 * @since 3.0
	 */
	public void testGrowNode_4() throws Exception {
		IGPProgram ind = new GPProgram(m_gpconf, 1);
		ProgramChromosome pc = new ProgramChromosome(m_gpconf, 50, ind);
		CommandGene[] funcSet = new CommandGene[] { CMD_SUB_I_I, // 0
				CMD_TERM0, // 1
				CMD_TERM1, // 2
				CMD_TERM2, // 3
		};
	 ...
	 * @since 3.0
	 */
	public void testGrowNode_4_2() throws Exception {
		IGPProgram ind = new GPProgram(m_gpconf, 1);
		ProgramChromosome pc = new ProgramChromosome(m_gpconf, 50, ind);
		CommandGene[] funcSet = new CommandGene[] { CMD_SUB_I_IM, // 0
				CMD_TERM0, // 1
				CMD_TERM1, // 2
				CMD_TERM2, // 3
		};
		...
		pc.growOrFullNode(0, 5, CommandGene.IntegerClass, 0, funcSet, null, 0,
				true, -1, false);
		pc.redepth();
	 ...
	 * @since 3.0
	 */
	public void testGrowNode_4_3() throws Exception {
		IGPProgram ind = new GPProgram(m_gpconf, 1);
		ProgramChromosome pc = new ProgramChromosome(m_gpconf, 50, ind);
		CommandGene[] funcSet = new CommandGene[] { CMD_SUB_I_IM, // 0
				CMD_TERM0, // 1
	 ...
	 * @since 3.0
	 */
	public void testGrowNode_5() throws Exception {
		IGPProgram ind = new GPProgram(m_gpconf, 1);
		ProgramChromosome pc = new ProgramChromosome(m_gpconf, 50, ind);
		CommandGene[] funcSet = new CommandGene[] { CMD_SUB_I_I, // 0
				CMD_SUB_I_I2, // 1
	 ...
	 * @since 3.0
	 */
	public void testToStringNorm_0() throws Exception {
	 ...
	 * @since 3.0
	 */
	public void testToStringNorm_1() throws Exception {
		ProgramChromosome pc = new ProgramChromosome(m_gpconf);
	 ...
	 * @since 3.0
	 */
	public void testToStringNorm_2() throws Exception {
		ProgramChromosome pc = new ProgramChromosome(m_gpconf);
	 ...
	 * @since 3.0
	 */
	public void testToStringNorm_3() throws Exception {
		ProgramChromosome pc = new ProgramChromosome(m_gpconf);
	 ...
	 * @since 3.0
	 */
	public void testToStringNorm_4() throws Exception {
		ProgramChromosome pc = new ProgramChromosome(m_gpconf);
		pc.setGene(0, new Modulo(m_gpconf, CommandGene.IntegerClass));
		pc.setGene(1, new Variable(m_gpconf, "X", CommandGene.IntegerClass));
		pc.setGene(2, new Variable(m_gpconf, "Y", CommandGene.IntegerClass));
	 ...
	 * @since 3.0
	 */
	public void testToStringNorm_5() throws Exception {
		ProgramChromosome pc = new ProgramChromosome(m_gpconf);
		pc.setGene(0, new Modulo(m_gpconf, CommandGene.IntegerClass));
	 ...
	 * @since 3.0
	 */
	public void testToStringNorm_6() throws Exception {
		ProgramChromosome pc = new ProgramChromosome(m_gpconf);
	 ...
	 * @since 3.0
	 */
	public void testToStringNorm_7() throws Exception {
		ProgramChromosome pc = new ProgramChromosome(m_gpconf);
		pc.setGene(0, new SubProgram(m_gpconf, new Class[] {
		...
		pc.setGene(6, new Constant(m_gpconf, CommandGene.IntegerClass,
				new Integer(7)));
		pc.redepth();
		String s = pc.toStringNorm(0);
	 ...
	 * @since 3.0
	 */
	public void testToStringNorm_8() throws Exception {
		ProgramChromosome pc = new ProgramChromosome(m_gpconf);
		pc.setGene(0, new SubProgram(m_gpconf, new Class[] {
				CommandGene.IntegerClass, CommandGene.IntegerClass }));
		pc.setGene(1, new Multiply(m_gpconf, CommandGene.IntegerClass));
		...
		pc.setGene(3, new Variable(m_gpconf, "Y", CommandGene.IntegerClass));
		pc.setGene(4, new Push(m_gpconf, CommandGene.IntegerClass));
		pc.setGene(5, new Constant(m_gpconf, CommandGene.IntegerClass,
				new Integer(9)));
		pc.redepth();
		String s = pc.toStringNorm(0);
	 ...
	 * @since 3.6
	 */
	public void testToStringNorm_9() throws Exception {
		ProgramChromosome pc = new ProgramChromosome(m_gpconf);
		pc.setGene(0, new Or(m_gpconf));
		pc.setGene(1, new Equals(m_gpconf, CommandGene.IntegerClass));
		pc.setGene(2, new Variable(m_gpconf, "X", CommandGene.IntegerClass));
		pc.setGene(3, new Constant(m_gpconf, CommandGene.IntegerClass,
				new Integer(3)));
	 ...
	 * @since 3.6
	 */
	public void testToStringNorm_A() throws Exception {
		ProgramChromosome pc = new ProgramChromosome(m_gpconf);
		pc.setGene(0, new Or(m_gpconf));
		pc.setGene(1, new Or(m_gpconf));
		pc.setGene(2, new Equals(m_gpconf, CommandGene.IntegerClass));
		pc.setGene(3, new Variable(m_gpconf, "X", CommandGene.IntegerClass));
		pc.setGene(4, new Constant(m_gpconf, CommandGene.IntegerClass,
				new Integer(3)));
		...
		pc.setGene(7, new Constant(m_gpconf, CommandGene.IntegerClass,
				new Integer(9)));
		...
		pc.setGene(10, new Constant(m_gpconf, CommandGene.IntegerClass,
				new Integer(1)));
		pc.redepth();
		String s = pc.toStringNorm(0);
	 ...
	 * @since 3.6
	 */
	public void testToStringNorm_B() throws Exception {
		ProgramChromosome pc = new ProgramChromosome(m_gpconf);
		pc.setGene(0, new Or(m_gpconf));
		pc.setGene(1, new Or(m_gpconf));
		pc.setGene(2, new Equals(m_gpconf, CommandGene.IntegerClass));
		...
		pc.setGene(7, new Constant(m_gpconf, CommandGene.IntegerClass,
				new Integer(9)));
		pc.setGene(8, new LesserThan(m_gpconf, CommandGene.IntegerClass));
		pc.setGene(9, new Constant(m_gpconf, CommandGene.IntegerClass,
				new Integer(1)));
	 ...
	 * @since 3.6
	 */
	public void testToStringNorm_C() throws Exception {
		ProgramChromosome pc = new ProgramChromosome(m_gpconf);
		pc.setGene(0, new Or(m_gpconf));
		pc.setGene(1, new Or(m_gpconf));
		pc.setGene(2, new Equals(m_gpconf, CommandGene.IntegerClass));
		...
		pc.setGene(13, new Constant(m_gpconf, CommandGene.IntegerClass,
				new Integer(4)));
		pc.setGene(14, new Variable(m_gpconf, "X", CommandGene.IntegerClass));
		pc.redepth();
		String s = pc.toStringNorm(0);
		assertEquals(
				"((Equals(3, X)) || (X > 9)) || ((Equals(1, X)) || (Equals(4, X)))",
				s);
	}
	 ...
	 * @since 3.0
	 */
	public void testRedepth_0() throws Exception {
		ProgramChromosome pc = new ProgramChromosome(m_gpconf);
		pc.setGene(0, new Add(m_gpconf, CommandGene.IntegerClass));
		pc.setGene(1, new Variable(m_gpconf, "X", CommandGene.IntegerClass));
		try {
	 ...
	 * @since 3.0
	 */
	public void testGetDepth_0() throws Exception {
		ProgramChromosome pc = new ProgramChromosome(m_gpconf);
		pc.setGene(0, new Add(m_gpconf, CommandGene.IntegerClass)); // Node 0
		pc.setGene(1, new Variable(m_gpconf, "Y", CommandGene.IntegerClass)); // Node
																				// 1
		pc.setGene(2, new Variable(m_gpconf, "Z", CommandGene.IntegerClass)); // Node
																				// 2
		pc.redepth();
	 ...
	 * @since 3.0
	 */
	public void testGetDepth_1() throws Exception {
		ProgramChromosome pc = new ProgramChromosome(m_gpconf);
	 ...
	 * @since 3.0
	 */
	public void testGetDepth_2() throws Exception {
		ProgramChromosome pc = new ProgramChromosome(m_gpconf);
		pc.setGene(0, new IfElse(m_gpconf, CommandGene.IntegerClass)); // Node 0
		pc.setGene(1, new Variable(m_gpconf, "Y", CommandGene.IntegerClass));
