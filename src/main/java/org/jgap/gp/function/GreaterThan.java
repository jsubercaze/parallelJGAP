...
public class GreaterThan
  ...
  public GreaterThan(final GPConfiguration a_conf, Class a_type)
...
//    }
  ...
  public Object clone() {
    try {
      GreaterThan result = new GreaterThan(getGPConfiguration(), m_type,
  ...
  public boolean equals(Object a_other) {
    if (a_other == null || ! (a_other instanceof GreaterThan)) {
      return false;
    }
    if (!super.equals(a_other)) {
      return false;
    }
    GreaterThan other = (GreaterThan) a_other;
